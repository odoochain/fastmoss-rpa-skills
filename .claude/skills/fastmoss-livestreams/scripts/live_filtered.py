...
from live_scraper import (  # noqa: E402
...
def main():
    ...
    p.add_argument("--ranking", required=True, choices=list(RANKINGS.keys()),
                   help="Livestream ranking to scrape (one of: %s)" % ", ".join(RANKINGS))
