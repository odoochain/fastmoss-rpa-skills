...
`<path-to-skill>` = the directory holding this skill's `SKILL.md` (`.claude/skills/fastmoss-livestreams` for project install, `~/.claude/skills/fastmoss-livestreams` for user install).
