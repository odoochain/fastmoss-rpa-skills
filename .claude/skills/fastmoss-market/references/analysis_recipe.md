...
`<path-to-skill>` = the directory holding this skill's `SKILL.md` (`.claude/skills/fastmoss-market` for project install, `~/.claude/skills/fastmoss-market` for user install).
