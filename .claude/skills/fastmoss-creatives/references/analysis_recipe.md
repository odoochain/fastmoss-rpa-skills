...
`<path-to-skill>` = the directory holding this skill's `SKILL.md` (`.claude/skills/fastmoss-creatives` for project install, `~/.claude/skills/fastmoss-creatives` for user install).
