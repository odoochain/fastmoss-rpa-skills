"""Aggregate FastMoss creative material CSVs into crosstabs for the analysis report.

Reads the CSVs produced by creative_scraper.py / creative_filtered.py and
...
Usage:
    python analyze.py --video <path> [--song <path>] [--hashtag <path>] \\
...
def main():
    ...
    p.add_argument("--video", help="热门视频 CSV")
    p.add_argument("--song", help="热门音乐 CSV")
    p.add_argument("--hashtag", help="热门标签 CSV")
