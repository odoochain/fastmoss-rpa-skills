...
from ads_scraper import (  # noqa: E402
...
def main():
    ...
    p.add_argument("--ranking", required=True, choices=list(RANKINGS.keys()),
                   help="Ads trend ranking to scrape (one of: %s)" % ", ".join(RANKINGS))
