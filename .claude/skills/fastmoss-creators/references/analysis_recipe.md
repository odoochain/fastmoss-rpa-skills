...
`<path-to-skill>` = the directory holding this skill's `SKILL.md` (`.claude/skills/fastmoss-creators` for project install, `~/.claude/skills/fastmoss-creators` for user install).
