...
`<path-to-skill>` = the directory holding this skill's `SKILL.md` (`.claude/skills/fastmoss-shops` for project install, `~/.claude/skills/fastmoss-shops` for user install).
